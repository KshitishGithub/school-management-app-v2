            ...
            <div class="row">
                <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        <h5 class="card-title">Edit Registration Form</h5>
                        <p><span class="text-danger">*</span> Indicates mandatory fields.</p>
                    </div>
                    <div class="card-body">
                        <form id="registrationFormUpdate" method="post" action="{{route('registered.update',['id'=>$student->id])}}">
                            <div class="row">
                                <div class="col-sm-1">
                                    ...
                                    <select class="form-control" name="class" id="selectedClass"
                                        ...
                                        @if ($classes->isNotEmpty())
                                            @foreach ($classes as $class)
                                                <option {{($student->class_id==$class->id) ? 'selected' : '' }} value="{{ $class->id }}">{{ $class->class }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
                                <div class="col-sm-1">
                                    <label class="col-form-label">Section <span class="text-danger selectLabel">{{($sections->isNotEmpty()) ? '*' : ''}}</span></label>
                                </div>
                                <div class="col-sm-3">
                                    <select class="form-control" name="section" id="section" optional="true"
                                        ...
                                        @if ($sections->isNotEmpty())
                                            @foreach ($sections as $section)
                                                <option {{($student->section_id==$section->id) ? 'selected' : '' }} value="{{ $section->id }}">{{ $section->section }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div> --}}
                            ...
                            <div class="row mt-md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control datetimepicker " name="dob" value="{{$student->dateOfBirth}}"
                            ...
                            <div class="row mt-md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="fathers_name" id="fathers_name" value="{{$student->fathersName}}">
                                </div>
                                <div class="col-sm-2">
                                    <label class="col-form-label">Qualification</label>
                                </div>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" optional="true" name="fathers_qualification" value="{{$student->fathersQualification}}" id="fathers_qualification">
                                </div>
                            </div>
                            <div class="row mt-md-4">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" optional="true" name="fathers_occupation"  value="{{$student->fathersOccupation}}"
                            ...
                            <div class="row mt-md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="mothers_name" id="mothers_name"  value="{{$student->mothersName}}">
                                </div>
                                <div class="col-sm-2">
                                    <label class="col-form-label">Qualification</label>
                                </div>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" optional="true"
                                        name="mothers_qualification" id="mothers_qualification" value="{{$student->mothersQualification}}">
                                </div>
                            </div>
                            <div class="row mt-md-4">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" optional="true" name="mothers_occupation"  value="{{$student->mothersOccupation}}"
                            ...
                            <div class="row mt-md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" optional="true" name="whatsapp_no"  value="{{$student->whatsapp}}"
                            ...
                            <div class="row mt-md-4">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" list="religion" name="religion"  value="{{$student->religion}}"
                            ...
                            <div class="row mt-md-4">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" list="caste" name="caste"  value="{{$student->caste}}"
                                        placeholder="Type to search...">
                                    <datalist id="caste">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" list="gander" name="gander" value="{{$student->gander}}"
                                        placeholder="Type to search...">
                                    <datalist id="gander">
                            ...
                            <div class="row mt-md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="village" id="village"  value="{{$student->village}}">
                                </div>
                                <div class="col-sm-2">
                                    <label class="col-form-label">Post Office<span class="text-danger"> *</span></label>
                                </div>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="post_office" id="post_office" value="{{$student->postOffice}}">
                                </div>
                            </div>
                            <div class="row mt-md-4">
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="police_station" value="{{$student->policeStation}}"
                                        id="police_station">
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="row mt-md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" name="pin" id="pin" value="{{$student->pin}}"
                                ...
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" optional="true" name="aadhar" id="aadhar" value="{{$student->aadhar}}"
                            ...
                            <div class="row mt-md-4">
                                ...
                                <div class="col-sm-4">
                                    <input type="file" class="form-control" name="photo" id="imageInput" {{(!empty($student->photo)) ? "optional=true" : "optional=false"}}
                                        accept="image/*">
                                </div>
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-4">
                                    <img class="img-fluid" id="imagePreview"
                                        src="{{ asset("uploads/images/registration/$student->photo") }}" alt="Image Preview"

...
@section('content')
                                    ...
                                    <tbody>
                                        @foreach ($examsData as $i => $exams)
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="actions">
                                                        <a href="{{ route('exam.edit', $exams->id ) }}" class="btn btn-sm bg-info-light mr-2"
                                                            id="eidt_exam">
                                                            <i class="feather-edit text-info" data-bs-toggle="tooltip"
                                                                data-bs-placement="top" title
                                                                data-bs-original-title="Edit Exam"></i>
                                                        </a>
                                                        ...
                                                        @if ($exams->is_published)
                                                            <a href="javascript:;"data-bs-toggle="tooltip"
                                                                data-bs-placement="top" title
                                                                data-bs-original-title="Result Published"
                                                        ...
                                                        @else
                                                            <a href="javascript:;" data-bs-toggle="tooltip"
                                                                data-bs-placement="top" title
                                                                data-bs-original-title="Publish Result"
                                                                class="btn btn-sm bg-danger-light"
                                                                data-exam_id="{{ $exams->id }}" id="publishBtn">
                                                                <i class="feather-check-square text-warning"></i>
                                                            </a>
                                                        @endif
    ...
    <div class="modal fade" id="modalTop" tabindex="-1" role="dialog" aria-labelledby="modalTopLabel"
        aria-hidden="true">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on("click", '#publishBtn', function(e) {
                ...
                var id = $(this).data("exam_id");
                swal({
                        title: "Are you sure want to Publish this exam ?",
                        icon: "warning",
                        buttons: true,
                        dangerMode: true,
                    })

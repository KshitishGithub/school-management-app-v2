    ...
    <div class="page-wrapper">
        <div class="content container-fluid">
            ...
            <div class="student-group-form">
                <form action="{{ route('exam.final_mark_sheet') }}" method="get">
                    <div class="row">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a data-bs-toggle="tooltip" data-bs-placement="top" title data-bs-original-title="Print Mark Sheet"
                                                        href="{{ route('exam.marksheet.finalMarkSheet', ['registration_id' => $student->registration_id,]) }}"

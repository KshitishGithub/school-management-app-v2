    ...
    <div class="contariner">
        <div class="header">
            <center>
                <img align="left" height="100" src="{{ asset('uploads/images/setting/' . $schoolDetails->logo) }}"
                    alt="gpschool.in">
                <img align="right" height="100" src="{{ asset('uploads/images/registration/' . $student->photo) }}"
                    alt="">
        ...
        <div class="body">
            <table class="table">
                ...
                <tr>
                    <td class="label" colspan="3">Session : <span>{{ $student->session }}</span>
                    </td>
                    <td align="right" class="label" colspan="3">Registration No :
                        <span>{{ config('website.registration') . $student->id }}</span>
                    </td>
                </tr>
                <tr>
                    <td class="label" colspan="3">Class : <span>{{ $student->class }}</span>
                    </td>
                    <td align="right" class="label" colspan="3">Section :
                        <span>{{ $student->section ?? 'NA' }}</span>
                    </td>
                </tr>
                <tr>
                    <td class="label" width="23%" colspan="1">Student Name : </td>
                    <td colspan="5"><u>{{ $student->name }}</u></td>
                </tr>
                <tr>
                    <td class="label" colspan="1">Father's Name : </td>
                    <td colspan="5"><u>{{ $student->fathersName }}</u></td>
                </tr>
                <tr>
                    <td class="label" colspan="1">Qualification : </td>
                    <td colspan="2"><u>{{ $student->fathersQualification ?? 'NA' }}</u></td>
                    <td class="label" colspan="1">Occupation : </td>
                    <td colspan="2"><u>{{ $student->fathersOccupation ?? 'NA' }}</u></td>
                </tr>
                <tr>
                    <td class="label" colspan="1">Mother's Name : </td>
                    <td colspan="5"><u>{{ $student->mothersName }}</u></td>
                </tr>
                <tr>
                    <td class="label" colspan="1">Qualification : </td>
                    <td colspan="2"><u>{{ $student->mothersQualification ?? 'NA' }}</u></td>
                    <td class="label" colspan="1">Occupation : </td>
                    <td colspan="2"><u>{{ $student->mothersOccupation ?? 'NA' }}</u></td>
                </tr>
                <tr>
                    <td class="label" colspan="1">Mobile No :</td>
                    <td colspan="2"><u>{{ $student->mobile }}</u></td>
                    <td class="label" colspan="1">WhatsApp No :</td>
                    <td colspan="2"><u>{{ $student->whatsapp ?? 'NA' }}</u></td>
                </tr>
                <tr>
                    <td class="label" colspan="1">Date of Birth :</td>
                    <td colspan="2"><u>{{ $student->dateOfBirth }}</u></td>
                    <td class="label" colspan="1">Religion :</td>
                    <td colspan="2"><u>{{ $student->religion }}</u></td>
                </tr>
                <tr>
                    <td class="label" colspan="1">Caste :</td>
                    <td colspan="2"><u>{{ $student->caste }}</u></td>
                    <td class="label" colspan="1">Nationality :</td>
                    <td colspan="2"><u>{{ $student->nationality }}</u></td>
                </tr>
                <tr>
                    <td class="label" colspan="1">Blood Group :</td>
                    <td colspan="2"><u>{{ $student->blood_group }}</u></td>
                    <td class="label" colspan="1">Gender :</td>
                    <td colspan="2"><u>{{ $student->gander }}</u></td>
                </tr>
                <tr>
                    <td class="label" colspan="1">Aadhar :</td>
                    <td colspan="5"><u>{{ $student->aadhar }}</u></td>
                </tr>
                <tr>
                    <td class="label" colspan="1">Transport :</td>
                    <td colspan="1"><u>{{ $student->transport }}</u></td>
                    <td class="label" colspan="1">Hostel :</td>
                    <td colspan="1"><u>{{ $student->hostel }}</u></td>
                    <td class="label" colspan="1">Mess :</td>
                    <td colspan="1"><u>{{ $student->mess }}</u></td>
                </tr>
                @if ($student->transport == 'Yes')
                    <tr>
                        <td class="label" colspan="1">Route :</td>
                        <td colspan="1"><u>{{ $student->route }}</u></td>
                        <td class="label" colspan="1">Bus Stops :</td>
                        <td colspan="1"><u>{{ $student->bus_stops }}</u></td>
                    </tr>
                @endif
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="2"><u>{{ $student->village }}</u> </td>
                    <td class="label" colspan="1">Post Office : </td>
                    <td colspan="2"><u>{{ $student->postOffice }}</u></td>
                </tr>
                <tr>
                    <td class="label" colspan="1">Police Station : </td>
                    <td colspan="1"><u>{{ $student->policeStation }}</u></td>
                    <td class="label" colspan="1">District : </td>
                    <td colspan="1"><u>{{ $student->district }}</u></td>
                    <td class="label" colspan="1">Pin : </td>
                    <td colspan="1"><u>{{ $student->pin }}</u> </td>
                </tr>
                <tr>
                    <td colspan="6">
                ...
                <tr>
                    <td class="label" colspan="3">Date :
                        <u>{{ \Carbon\Carbon::parse($student->created_at)->format('d-m-Y') }}</u>
                    </td>

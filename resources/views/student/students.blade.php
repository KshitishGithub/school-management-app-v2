            ...
            <div class="student-group-form">
                <form action="{{ route('students.list') }}" method="get">
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="search-student-btn">
                                <a href="{{ route('students.list') }}" class="btn btn-primary">Reset</a>
                            </div>
                        </div>
                    </div>
                </form>
                                                    ...
                                                    <div class="dropdown dropdown-action">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            ...
                                                            <a class="dropdown-item"
                                                                href="{{ route('registered.editStudent', ['id' => encrypt($student->id)]) }}"><i
                                                            ...
                                                            <a class="dropdown-item" target="_black" data-bs-toggle="tooltip" data-bs-placement="top" title data-bs-original-title="Students Profile"
                                                                href="{{ route('students.profile', ['id' => encrypt($student->id)]) }}"><i
                                                            ...
                                                            <a class="dropdown-item" target="_black" data-bs-toggle="tooltip" data-bs-placement="top" title data-bs-original-title="Print Students Form"
                                                                href="{{ route('print.registration.form', ['id' => encrypt($student->id)]) }}"><i

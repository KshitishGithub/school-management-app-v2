...
@section('content')
    @push('title')
        <title>Approve Leave List</title>
    @endpush
    @php
        define('PAGE', 'approve_leave');
    @endphp
                        ...
                        <div class="card-body">
                            <div class="page-header">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <h3 class="page-title">Approve Leave List</h3>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table
                                    ...
                                    <tbody>
                                        @if ($approveLeaves->isNotEmpty())
                                            @foreach ($approveLeaves as $key => $leave)
                                                <tr>
                                                    <td>{{ ++$key }}</td>
                                                    <td>{{ $leave->name }}</td>
                                                    <td>{{ $leave->class }}</td>

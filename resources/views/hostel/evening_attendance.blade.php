...
@section('content')
    @push('title')
        <title>Hostellers QR Attendance</title>
    @endpush
    @php
        define('PAGE', 'qr_evening_attendance');
    @endphp
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col">
                        <h3 class="page-title">QR Attendance System</h3>
                        <ul class="breadcrumb">
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <div class="card-header">
                                                    <h5 class="card-title">Evening Attendance</h5>
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        function qr_attendance(registration_id, session, className, section, roll, value, type) {
            if (value !== '') {
                ...
                // console.log(data);
                $.ajax({
                    url: "{{ route('hostel.fill_evening_attendance') }}",
                    type: "post",
                    data: data,
                    headers: {
                    ...
                    success: function(response) {
                        ...
                        if (response.status) {
                            ...
                            var sound = document.getElementById('radhe');
                            sound.play();
                        }else{
                            Swal.fire({
                                title: "Opps !",

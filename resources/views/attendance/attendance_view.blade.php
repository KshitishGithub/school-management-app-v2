                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        <a href="{{ route('attendance.fill') }}" class="btn btn-primary">Fill Attendance</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="card card-primary">
                                    <div class="card-body" id="attendance_detail">
                                        ...
                                        <form action="{{ route('attendance.view') }}" method="get">
                                            <div class="row">
                                                <div class="col-md-2">
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <button style="width:100px;" type="button"
                                                        class="btn btn-success">Thursday</button>
                                                    <button style="width:100px;" type="button"
                                        ...
                                        <div class="row table-responsive" style="margin-top:20px">
                                            <table id="example1" class="table table-bordered table-striped"
                                                ...
                                                <thead class="my_background_color">
                                                    <tr>
                                                        <th>Student Name</th>
                                                        <th><span id="by_month">{{ $data['year'] }}-{{ $data['month'] }}</span>
                                                            Month Attendance</th>
                                                ...
                                                <tbody id="stud_list">
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            ...
                                                            <button
                                                                style="width:50px;padding:1px;font-size:12px;height:25px;"
                                                                type="button" class="btn btn-success">Thursday</button>
                                                            <button
                                                                style="width:50px;padding:1px;font-size:12px;height:25px;"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    @foreach ($attendanceData['attendance'] as $attendance)
                                                                        ...
                                                                        @elseif ($attendance['attendance'] == 'T')
                                                                            <input type="text"
                                                                                value="{{ $attendance['attendance'] }}"
                                                                                class="form-control btn-default text-center text-light"
                                                                                readonly
                                                                    ...
                                                                    <button
                                                                        style="width:50px;font-size:14px;height:25px;padding:2px;"
                                                                        type="button"
                                                                        class="btn btn-success">{{ $attendanceData['summary_counts']['T'] }}</button>
                                                                    <button
                                                                        style="width:50px;font-size:14px;height:25px;padding:2px;"
                                                                        type="button"
